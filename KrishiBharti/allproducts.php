               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="product_box">
                          <h4 class="bursh_text">Farmer id<?php echo $row['farmer_id'];?></h4>
                         <h4 class="bursh_text"><?php echo $row['name'];?></h4>
                        <h4 class="lorem_text">Description:<?php echo $row['description']; ?></h4>
                         <p class="bursh_text"> Pesticides Used:<?php echo $row['persticide']; ?></p>
                        <img src="<?php echo $row['image'];?>" class="image_1">
                        <div class="btn_main">
                           <div class="buy_bt">
                              <ul>
<!--                                 <li class="active"><a href="#">Buy Now</a></li>-->
<li><a href="orderIndex.php?pname=<?php echo $row['name'];?>&fid=<?php echo $row['farmer_id'];?>&uid=<?php echo $uid; ?>">Buy Now</a></li>
                              </ul>
                           </div>
                          <h3 class="price_text">₹<?php echo $row['price']; ?></h3>
                        </div>
                     </div>
                  </div>
<!--                  <div class="col-lg-3 col-sm-6">
